...
namespace ProjectR.Backrooms.Debugging
{
    ...
    [MovedFrom(true, sourceNamespace: "ProjectR.Backrooms.Measurement", sourceAssembly: "ProjectR.Backrooms", sourceClassName: "BackroomsSoakRunner")]
    public class BackroomsSoakRunner : SWMonoBehaviour
    {
        #region 필드
        /// <summary>인스펙터 버튼으로 시작할 때 사용할 재생성 횟수입니다.</summary>
        [SWGroup("측정 설정")]
        [SerializeField, Range(1, 1000), Tooltip("인스펙터 버튼으로 시작할 때 사용할 재생성 횟수입니다.")]
        private int defaultCycleCount = 100;

        /// <summary>몇 회마다 중간 결과를 로그로 남길지입니다.</summary>
