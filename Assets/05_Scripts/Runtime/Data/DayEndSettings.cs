...
namespace ProjectR.Data
{
    ...
    public struct DayEndSettings
    {
        ...
        private int minBroadcastMinutes;
        #endregion // 필드
        ...
        public int MinBroadcastMinutes => minBroadcastMinutes;
        ...
        /// <param name="minBroadcastMinutes">어떤 이유로도 이 아래로는 내려가지 않는 방송 시간(분)입니다.</param>
        /// <remarks>
        ...
        public DayEndSettings(int baseUpkeep, float upkeepPerViewer, float idleChurnRate,
            ...
            int failurePenaltyMinutes, int minBroadcastMinutes)
        {
            ...
            this.minBroadcastMinutes = minBroadcastMinutes;
        }
        #endregion // 함수
    }
}
