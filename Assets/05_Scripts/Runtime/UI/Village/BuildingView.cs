...
namespace ProjectR.UI.Village
{
    ...
    [MovedFrom(true, sourceNamespace: "ProjectR.UI.Home", sourceAssembly: "ProjectR.UI", sourceClassName: "BuildingView")]
