    ...
    public class HomeScreen : SWMonoBehaviour
    {
        ...
        private void Awake()
        {
            for (int index = 0; index < buildings.Length; index++)
            {
                ...
                buildings[index].ApplyDefinition();
                buildings[index].Clicked += HandleBuildingClicked;
                buildings[index].HoverChanged += HandleBuildingHoverChanged;
            }
        ...
        private void Refresh()
        {
            ...
            for (int index = 0; index < buildings.Length; index++)
                if (buildings[index] != null) buildings[index].Refresh(state);
